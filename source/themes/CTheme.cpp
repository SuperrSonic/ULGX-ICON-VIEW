...
void Theme::Reload()
{
	...
	btnSoundClick3 = new GuiSound(Resources::GetFile("button_click3.wav"), Resources::GetFileSize("button_click3.wav"), Settings.sfxvolume);
	btnSoundAccept = new GuiSound(Resources::GetFile("button_accept.wav"), Resources::GetFileSize("button_accept.wav"), Settings.sfxvolume);
	btnSoundBack = new GuiSound(Resources::GetFile("button_back.wav"), Resources::GetFileSize("button_back.wav"), Settings.sfxvolume);
