...
GuiBannerGrid::GuiBannerGrid(int listOffset)
	...
	, gridFrameColor(thColor("r=0 g=0 b=0 a=0 - banner icon frame color"))
	, highliteColor(thColor("r=0 g=0 b=0 a=0 - banner icon highlite color"))
{
	GXColor gridTevColor[3];
	gridTevColor[0] = thColor("r=0 g=0 b=0 a=0 - banner icon frame edge tev color 1");
	gridTevColor[1] = thColor("r=0 g=0 b=0 a=0 - banner icon frame edge tev color 2");
	gridTevColor[2] = thColor("r=0 g=0 b=0 a=0 - banner icon frame edge tev color 3");
...
void GuiBannerGrid::Draw()
{
	...
	for(int sIdx = -24; sIdx < 36; sIdx++, chIdx++)
	{
		...
		{
			Menu_DrawRectangle(0, 0, screenwidth, screenheight, (GXColor) { 0, 0, 0, 0}, 1);
